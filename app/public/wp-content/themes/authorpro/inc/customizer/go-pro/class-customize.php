 ...
 * @access public
 */
final class Authorpro_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Authorpro_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new Authorpro_Customize_Section_Pro(
				$manager,
				'go-pro',
				array(
					'priority'       => 1,
					'pro_text' => esc_html__( 'Upgrade To Pro', 'authorpro' ),
...
Authorpro_Customize::get_instance();
