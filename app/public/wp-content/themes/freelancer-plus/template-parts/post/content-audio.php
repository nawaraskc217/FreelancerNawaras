      ...
      <?php
        ...
        <header class="entry-header">
            ...
            <?php if ('post' == get_post_type()) : ?>
                <div class="postmeta">
                    <?php if (get_theme_mod('freelancer_plus_metafields_date', true)) : ?>
                        <div class="post-date">
                    ...
                    <?php endif; ?>  
                    <?php if (get_theme_mod('freelancer_plus_metafields_comments', true)) : ?>  
                    ...
                    <?php endif; ?>
                    <?php if (get_theme_mod('freelancer_plus_metafields_author', true)) : ?>
                    ...
                    <?php endif; ?>
                    <?php if (get_theme_mod('freelancer_plus_metafields_time', true)) : ?>
                        <div class="post-time">&nbsp; &nbsp;
                            <a href="#">
