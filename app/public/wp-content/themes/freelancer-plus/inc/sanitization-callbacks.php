 ...
 */
function freelancer_plus_sanitize_css( $css ) {
 ...
 */
function freelancer_plus_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function freelancer_plus_sanitize_email( $email, $setting ) {
 ...
 */
function freelancer_plus_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function freelancer_plus_sanitize_html( $html ) {
 ...
 */
function freelancer_plus_sanitize_image( $image, $setting ) {
 ...
 */
function freelancer_plus_sanitize_nohtml( $nohtml ) {
 ...
 */
function freelancer_plus_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function freelancer_plus_sanitize_number_range( $number, $setting ) {
 ...
 */
function freelancer_plus_sanitize_select( $input, $setting ) {
 ...
 */
function freelancer_plus_sanitize_url( $url ) {
	return esc_url_raw( $url );
}

/*radio button sanitization*/
function freelancer_plus_sanitize_choices( $input, $setting ) {
    global $wp_customize;
...
if ( ! function_exists( 'freelancer_plus_sanitize_integer' ) ) {
	function freelancer_plus_sanitize_integer( $input ) {
		return (int) $input;
	}
}
