...
class Astra_Footer_Menu_Component {
	...
	public static function menu_markup() {
		...
		if ( has_nav_menu( 'footer_menu' ) ) {
			$footer_menu_markup = wp_nav_menu(
				array(
					'depth'           => 1,
			...
			$footer_menu_markup = str_replace( '#389 (no title)', 'Contact', $footer_menu_markup );
			echo do_shortcode( $footer_menu_markup ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		}
	}
}
